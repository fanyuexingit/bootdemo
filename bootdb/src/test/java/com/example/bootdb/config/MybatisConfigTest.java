...
public class MybatisConfigTest {
    ...
    @Autowired
    private UserMapper userMapperSecondary;
    ...
    public void test() throws Exception {
        // 往Primary数据源插入一条数据
        userMapperPrimary.insert("AAA", 20, "AAA");
        ...
        // 往Secondary数据源插入一条数据
        userMapperSecondary.insert("BBB", 20, "BBB");
